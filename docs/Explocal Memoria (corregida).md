...
![](media/image2.wmf){width="3.6145833333333335in" height="2.3125in"}
...
![](media/image3.wmf) (2-1)

![](media/image4.wmf) (2-2)

![](media/image5.wmf) (2-3)
...
![](media/image6.wmf) (2-4)

![](media/image7.wmf) (2-5)

![](media/image8.wmf) (2-6)
...
![](media/image12.wmf) ![](media/image13.wmf) ![](media/image14.wmf)
(2-8)

Estas conclusiones se representan gráficamente en la ***figura 2-2***.

![](media/image15.wmf){width="5.895833333333333in"
...
![](media/image17.wmf){width="5.895833333333333in" height="5.09375in"}
...
![](media/image20.wmf){width="5.895833333333333in" height="5.09375in"}
...
|                                                           |                                                           |
| ![](media/image21.wmf){width="1.7291666666666667in"       | ![](media/image22.wmf){width="1.7291666666666667in"       |
...
![](media/image23.wmf){width="5.895833333333333in"
height="5.104166666666667in"}
...
![](media/image24.wmf), **j = 1,2,\..., Ne;** (3-2)
...
**CO~2~ + H~2~ ⇔ CO + H~2~O ;** ![](media/image26.wmf)**;** (3-5)

**CO~2~ + C ⇔ 2 CO;** ![](media/image27.wmf)**;** (3-6)
...
![](media/image28.wmf)**;** (3-7) ![](media/image29.wmf)**;** (3-8)

![](media/image30.wmf) (3-9)
...
![](media/image31.wmf){width="5.895833333333333in"
height="5.104166666666667in"}
...
![](media/image32.wmf){width="5.895833333333333in"
height="5.104166666666667in"}
...
![](media/image35.wmf){width="5.854166666666667in"
...
![](media/image36.wmf) (3-27)![](media/image37.wmf)
![](media/image38.wmf) (3-28)
...
![](media/image43.wmf) (3-36)

![](media/image44.wmf) (3-37)

![](media/image45.wmf) (3-38)

![](media/image46.wmf) (3-39)

![](media/image47.wmf) (3-40)
...
+------------------------+-------------------------------------------------------------+
| ![](media/image48.wmf) | Masa mo[le]{.underline}cular media de los productos         |
|                        | gaseosos, en (g/mol).                                       |
|                        |                                                             |
...
![](media/image49.wmf){width="5.979166666666667in"
height="3.8125in"}[^6]
...
![](media/image50.wmf){width="5.927083333333333in"
...
![](media/image51.wmf){width="3.9479166666666665in"
...
![](media/image52.wmf){width="4.71875in" height="2.9791666666666665in"}
...
![](media/image53.wmf){width="2.8541666666666665in" height="6.15625in"}
...
![](media/image54.wmf){width="5.802083333333333in"
...
|---|---|---|---|
| [A]{.underline}rchivo | [N]{.underline}uevo | \-- | Creando una ventana hija de texto vacía. |
| | [A]{.underline}brir\... | \-- | Abre un archivo de texto del disco. Emplea un cuadro de diálogo para seleccionar el nombre del archivo. |
| | [G]{.underline}uardar | \-- | Guarda el *archivo de texto* correspondiente a la ventana hija activa. |
| | Guardar [c]{.underline}omo\... | \-- | Guarda un *archivo de texto* en el disco. Emplea un cuadro de diálogo para seleccionar el nombre del archivo. |
| | [I]{.underline}mprimir | \-- | Saca por impresora el texto de la ventana hija. |
| | [P]{.underline}referencias\... | \-- | Cuadro de diálogo de preferencias. |
| | [S]{.underline}alir | Alt + F4 | Abandona la aplicación, cerrando la ventana principal y las ventanas hijas abiertas. |
| [E]{.underline}dición | [D]{.underline}eshacer | Ctrl + Z | Borra la última operación realizada el editor de la ventana hija activa. |
| | [C]{.underline}ortar | Ctrl + X | Elimina el texto seleccionado en el editor de la ventana hija activa y copia el texto seleccionado al portapapeles. |
| | [C]{.underline}opiar | Ctrl + C | Copia el texto seleccionado de la ventana hija activa al portapapeles. |
| | [P]{.underline}egar | Ctrl + V | Copia el contenido de portapapeles en el editor a partir de la posición del cursor. |
| | [B]{.underline}orrar | Supr | Elimina el texto seleccionado del editor. |
| | Bo[r]{.underline}rar todo | Ctrl+Sup | Elimina todo el contenido del editor de texto. |
| | [S]{.underline}eleccionar todo | Ctrl + E | Extiende la selección a todo el texto del editor de la ventana hija activa. |
| Buscar | [B]{.underline}uscar\... | \-- | Busca en el editor, la primera aparición del texto introducido mediante un cuadro de diálogo. |
| | [R]{.underline}epetir búsqueda | F3 | Busca la siguiente aparición del texto introducido anteriormente, en la ventana hija activa. |
| | R[e]{.underline}emplazar\... | \-- | Reemplaza el texto seleccionado por otro. |
| [E]{.underline}xplosivo | [N]{.underline}uevo explosivo\... | F5 | Después de que se introduzcan los datos del explosivo, con la ayuda de tres cuadros de diálogo, crea una ventana hija conteniendo los resultados del explosivo. |
| | [A]{.underline}brir explosivo\... | F6 | Carga los datos del explosivo del disco y muestra los resultados en una ventana hija. |
| | [G]{.underline}uardar explosivo | \-- | Guarda los datos del explosivo introducido, en el archivo asociado al explosivo. |
| | G[u]{.underline}ardar explosivo como\... | \-- | Guarda los datos del explosivo asociado a la ventana hija activa, en el archivo cuyo nombre se introduce mediante un cuadro de diálogo. |
| | [M]{.underline}odificar composición\... | F7 | Cambia los datos del explosivo asociado a la ventana hija activa y actualiza los resultados. |
| | M[o]{.underline}dificar lista de reactivos\... | \-- | Accede al archivo de datos REACTIVO.DAT y permite modificar su contenido. |

(Continúa)

| **Selec.** | **Submenú** | **Tecla acel.** | **Descripción de la función.** |
|---|---|---|---|
| [V]{.underline}entana | [C]{.underline}ascada | May+F5 | Organiza todas las ventanas hijas abiertas, solapando unas con otras. |
| | [M]{.underline}osaico | May+F4 | Organiza todas las ventanas hijas abiertas, cubriendo todo el espacio de la ventana marco. |
| | [O]{.underline}rganizar iconos | \-- | Coloca y ordena los iconos de las ventanas hijas minimizadas. |
| | C[e]{.underline}rrar todo | \-- | Cierra todas las ventanas hijas. |
| Ay[u]{.underline}da | [Í]{.underline}ndice | F1 | Acceso al índice del archivo de ayuda. |
| | [B]{.underline}uscar ayuda sobre\... | \-- | Acceso al contenido del archivo de ayuda. |
| | [A]{.underline}cerca de Explocal\... | \-- | Muestra en pantalla un cuadro de diálogo con información sobre ***Explocal***. |
...
|---|---|---|
| [A]{.underline}rchivo/ [A]{.underline}brir\...; [E]{.underline}xplosivo/[A]{.underline}brir explosivo\... | SD_FILEOPEN | Abrir |
| [A]{.underline}rchivo/Guardar [c]{.underline}omo\...; [E]{.underline}xplosivo/G[u]{.underline}ardar explosivo como\... | SD_FILESAVE | Guardar como |
| [B]{.underline}uscar/ [B]{.underline}uscar\... | SD_SEARCH | Buscar |
| [B]{.underline}uscar/ R[e]{.underline}emplazar\... | SD_REPLACE | Reemplazar |
| [E]{.underline}xplosivo/[N]{.underline}uevo explosivo\...; DIALOGO_2/Botón(Cancelar) | DIALOGO_1 | Composición cualitativa de la mezcla explosiva. |
| DIALOGO_1/Botón(Aceptar) DIALOGO_3/ Botón(Cancelar); [E]{.underline}xplosivo/[M]{.underline}odificar composición\... | DIALOGO_2 | Composición cuantitativa de la mezcla. |
| DIALOGO_2/ Botón(Aceptar) | DIALOGO_3 | Introducir datos adicionales. |
| [E]{.underline}xplosivo/M[o]{.underline}dificar lista de reactivos\...; DIALOGO_5/ Botón(Cancelar); DIALOGO_5/ Botón(Aceptar) | DIALOGO_4 | Modificar la lista de reactivos. |
| DIALOGO_4/Botón(Añadir) | DIALOGO_5 | Introducir datos del reactivo. |
| [A]{.underline}rchivo/[P]{.underline}referencias\... | DIALOGO_6 | Preferencias |
| Ay[u]{.underline}da/[A]{.underline}cerca de Explocal\... | DIALOGO_ACERCA | Acerca de Explocal |
...
![](media/image67.wmf){width="5.302083333333333in"
...
características teóricas de los explosivos" en [Memorial de]{.underline}
[ingeniería de armamento]{.underline}, nº 124 ·3^er^ Trimestre 1991

\[3\] KAMLET, Mortimer.J. y JACOBS, S.J, "Chemistry of Detonations"

\(1968\) en [The Journal of Chemical Physics]{.underline}, Vol. 48 nº 1
(1 enero)

pp. 23-50.

\[4\] FORUM ATÓMICO ESPAÑOL (1991): [Tabla periódica de los]{.underline}
[elementos]{.underline}. *FAE (Madrid).*

\[5\] JANAF (1971): [Thermochemical Tables.]{.underline} *Office of
Standard Reference Data, National Bureau of Standards. Washington, D.C.*

\[6\] LIDE, David R. (1989): [CRC Handbook of Chemistry and]{.underline}
[Physics]{.underline}. *CRC Press Inc., Boca Raton (Florida)*

\[7\] MEYER, R. (1987): [Explosives.]{.underline} *VCH
Verlagsgesellschaft mbH. Weinheim, (Alemania).*

\[8\] TSIPKIN, G.G y TSIPKIN, A.G. (1988): [Fórmulas
Matemáticas]{.underline} [Algebra Geometría Análisis
matemático.]{.underline} *Mir, Moscú.*

\[9\] MADER, C.L. (1963): [Detonation Properties of
Condensed]{.underline} [Explosives Computed Using the
Becker-Kistiakowsky-Wilson]{.underline} [Equation of State. Report
LA-2900]{.underline}. *Los Alamos Scientific Laboratory*

*\*

# BIBLIOGRAFÍA[]{.indexref entry="BIBLIOGRAFÍA."} {-}

\- ADAMS, Lee (1994): [Programación avanzada de gráficos]{.underline}
[en C para Windows]{.underline}. *Windcrest McGraw-Hill, Madrid.*

\- AGUILAR, F. (1972): [Los explosivos y sus aplicaciones.]{.underline}
*Servicio de Publicaciones de la J.E.N., Madrid.*

\- CLEMENT SHAMMAS, Namir (1993): [Guía de programación]{.underline} [en
Windows. Librería ObjectWindows]{.underline}. *Anaya Multimedia,
Madrid.*

\- COOK, M.A. (1985): [The Science of High Explosives.]{.underline}
*Robert E. Krieger Publishing Company, Malabar (Florida).*

\- FICKETT, W. y DAVIS, W. C. (1979): [Detonation.]{.underline}
*University of California Press, Berkeley y Los Angeles.*

\- FRANCO GARCÍA, Ángel (1995): [Desarrollo avanzado de]{.underline}
[aplicaciones Windows con Borland C++ 4.0 y ObjectWindows
2.0]{.underline} *McGraw-Hill, Madrid.*

\- JOHANSSON, C.H. y Persson, P.A. (1970), [Detonics of
High]{.underline} [Explosives.]{.underline} *Academic Press, Inc.*

\- KERNIGHAN, Brian W. y RITCHIE, Dennis M. (1985) [: El
lenguaje]{.underline} [de programación C]{.underline}. *Prentice Hall,
Barcelona*.

\- MADER, C. L., (1979): [Numerical Modeling of
Detonations.]{.underline} *University of California Press, Berkeley y
Los Angeles.*

\- SAWTELL, Christopher (1993): [Syllabus for the C Language
Course]{.underline} *chris@gerty.equinox.gen.nz. correo electrónico,
Linwood (Nueva Zelanda)*

\- SCHILDT, Herbert (1994): [Aplique Turbo C++ para Windows]{.underline}
. *Osborne McGraw-Hill, Madrid*.

\- THORIN, Marc (1987): [Ingeniería del software]{.underline}.
*Paraninfo, Madrid*

\- ZIMMERMAN, Scott y B. ZIMMERMAN, Beverly (1990): [La biblia del TURBO
C. Fundamentos y técnicas avanzadas de]{.underline}
[programación]{.underline}. *Anaya Multimedia, Madrid*
