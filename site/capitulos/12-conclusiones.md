...
proyecto, es una versión de las denominadas Beta y por lo tanto no es
definitiva.

Como ya se hizo notar, el desarrollo de una aplicación informática no
termina **nunca** (siempre se puede modificar, mejorar, adaptar...) y es
necesario cortar el proceso cíclico de desarrollo, una vez rebasado
cierto punto.
